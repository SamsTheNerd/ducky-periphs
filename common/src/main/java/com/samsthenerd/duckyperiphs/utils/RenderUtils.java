...
// everything in here was not really good,,
public class RenderUtils{
    ...
    // public static void drawFrameBuffer(DrawContext context, int argb, Framebuffer readFromBuffer, int writeToBufferId){
    ...
    //     Window window = MinecraftClient.getInstance().getWindow();
    //     DrawContext.drawTexture(context, 0, 0,

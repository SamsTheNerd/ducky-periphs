...
import net.fabricmc.duckyperiphs.DPRecipeSerializer;
...
public class KeyboardRecipe extends SpecialCraftingRecipe {
    private static final Ingredient KEYBOARD = Ingredient.ofItems(DuckyPeriph.KEYBOARD_ITEM);
    ...
    public RecipeSerializer<?> getSerializer() {
        return DPRecipeSerializer.KEYBOARD_RECIPE;
    }
